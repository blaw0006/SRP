#!/usr/bin/bash
DATASET_DIR="/home/acrv/blaw_ws/ur5_control/src/SRP/src/4_mic_data/mp3_data/mic1_data_training_50"
#DATASET_DIR="/home/acrv/blaw_ws/ur5_control/src/SRP/src/4_mic_data/mp3_data/Training"

WORKSPACE="/home/acrv/blaw_ws/workspace_split_data" 
...
python3 pytorch/main.py train --dataset_dir=$DATASET_DIR --workspace=$WORKSPACE --holdout_fold=2 --model_type="Transfer_Cnn14_16k" --pretrained_checkpoint_path=$PRETRAINED_CHECKPOINT_PATH --loss_type=clip_nll --augmentation='mixup' --learning_rate=1e-4 --batch_size=4 --resume_iteration=0 --stop_iteration=1000 --cuda
